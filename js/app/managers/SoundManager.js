function SoundManager()
{
    ...
    var spriteArray = [
        {
            name: "soundSprite",
            mp3_url: 'media/audio/sound_sprite.mp3',
            ogg_url: 'media/audio/sound_sprite.ogg',
            volume:1.0,
            sprite:
            {
                silence: [0,100],
    ...
    this.init = function()
    {
        ...
        else
        {
            ...
            {
                if(IS_MOBILE_DEVICE) document.body.addEventListener("touchstart", capturingFirstUserInteraction, false);
                else initAudioArray(spriteArray);
            }
            else initAudioArray(soundsArray);
        }
    };
