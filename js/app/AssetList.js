var assetList =
{
    ...
    loader: [
        ...
        { name: "percentage", url:"stage_level/percentage.png", type: "BGDiv", width: 35, height: 38, left: "51.5%", top: "63%" },
        { name: "smallNumber", url: "stage_level/number_spritesheet_small.png", type: "BGDiv", width: 33, height: 48, columns: 10, rows: 1, multiple: 2 }
    ],
    ui: [],
    sounds: [],
    list: [
        { name: "ShockwaveWalkCycle", url: "spritesheets/shockwave.png", type:"spritesheet", width: 960, height: 1200, columns: 12, rows: 8 },
    ]
};